...
from order.views import SalesByPayment, SalesByMarket, SalesByRegion, LateDeliveryByRegion,DeliveryPerformanceByDepartments
...
urlpatterns = [
   ...
   path('stats/deliveryperformance-by-top10departments/', DeliveryPerformanceByDepartments.as_view(), name="Delivery Performance by Top 10 Departments")
]
